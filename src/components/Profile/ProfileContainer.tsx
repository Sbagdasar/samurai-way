...
export default compose<React.ComponentType>(connect(mapStateToProps, {getProfileTC, getStatusTC, updateStatusTC}), withAuthRedirect, withRouter)(ProfileContainer)
